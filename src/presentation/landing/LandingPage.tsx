...
export function LandingPage({ incident, hasSavedIncident, scenario, onStart, onResume, onAbandon, onSelectScenario }: { incident: IncidentState; hasSavedIncident: boolean; scenario: ScenarioDefinition; onStart: () => void; onResume: () => void; onAbandon: () => void; onSelectScenario: (scenarioId: string) => void }) {
