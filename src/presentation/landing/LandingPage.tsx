...
export function LandingPage({ scenario, onStart, onSelectScenario }: { scenario: ScenarioDefinition; onStart: () => void; onSelectScenario: (scenarioId: string) => void }) {
  return <main className="relative min-h-screen overflow-hidden bg-[#080b10] px-5 py-8 text-slate-100 sm:px-8 lg:px-12">
    ...
    <div className="relative mx-auto max-w-6xl">
      ...
      <ScenarioCatalog onSelectScenario={onSelectScenario} />
