...
export function IncidentHeader() {
  ...
  const connections = incident.metrics.openConnections.value;
  const impact = incident.flags.trafficPaused ? "Severe" : connections >= 90 ? "High" : connections > 75 ? "Growing" : "Low";
