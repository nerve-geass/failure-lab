...
describe("scenario registry", () => {
  ...
  it("exposes the application registry object", () => {
    ...
    expect(listScenarios(scenarioRegistry).map((scenario) => scenario.id)).toEqual(["retry-storm", "cache-stampede", "queue-consumer-lag", "connection-pool-exhaustion", "bad-deployment", "memory-leak"]);
  });
